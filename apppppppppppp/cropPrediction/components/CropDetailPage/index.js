...
const plants = [
    ...
    {
      name: "grape",
      image:require('../../assets/base_plants/grape.jpg'),
    ...
    {
      name: "peach",
      image:require('../../assets/base_plants/peach.jpg'),
      planting: "A VERY LONG DEscription",
      care:"something..",
      pest_diseases:"sdsp",
      harves:"sad"
    ...
    {
      name: "potato",
      image:require('../../assets/base_plants/potato.jpg'),
    ...
    {
      name: "tomato",
      image:require('../../assets/base_plants/tomato.jpg'),
    ...
    {
      name: "corn",
      image:require('../../assets/base_plants/corn.jpg'),
      planting: "A VERY LONG alright",
      care:"something..",
      pest_diseases:"sdsp",
      harves:"sad"
    ...
    {
      name: "strawberry",
      image:require('../../assets/base_plants/strawberry.jpg'),
      planting: "A VERY LONG DEscription",
      care:"something..",
      pest_diseases:"sdsp",
      harves:"sad"
  ...
  render() {
    ...
    return (
      <ScrollView>
        ...
        <Button title="Select Image" onPress={this.showPicker}/>
          
        <Image source={this.state.img} style={{height:200,width:200}} />
