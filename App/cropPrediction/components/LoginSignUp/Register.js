            ...
            <Container>
                <Content>
                    ...
                    <View style={{paddingLeft: 20, paddingRight: 20}}>
                        ...
                        <Button rounded info 
                        style={{textAlign:'center',justifyContent:'center',width:260 ,marginTop: 30, alignSelf: 'center', backgroundColor:"#286028"}} onPress={() => this.props.navigation.navigate('loginSignUp')  }   >
                            <Text >Register</Text>
                        </Button>
